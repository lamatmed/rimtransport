...
import { Mail, Lock, CarFront, Eye, EyeOff, ArrowRight, Sparkles, Fingerprint } from 'lucide-react-native';
...
export default function LoginScreen() {
  ...
  const handleBiometricLogin = () => {
    // Implémenter la connexion biométrique ici
        ...
        >
          ...
          >
            ...
            <View style={styles.formContainer}>
              ...
              <TouchableOpacity 
                style={[styles.biometricButton, { backgroundColor: isDark ? '#1C1C2A' : '#F5F5FA' }]}
              ...
              <View style={styles.divider}>
                ...
                <Text style={[styles.dividerText, { color: isDark ? '#8E8E9E' : '#B0B0C0' }]}>ou continuer avec</Text>
                <View style={[styles.dividerLine, { backgroundColor: isDark ? '#2C2C3A' : '#EFEFF5' }]} />
              </View>
              ...
              <View style={styles.socialContainer}>
                <TouchableOpacity 
                  style={[styles.socialButton, { backgroundColor: isDark ? '#1C1C2A' : '#F5F5FA' }]}
                  activeOpacity={0.7}
                >
              ...
              <View style={styles.decorativeContainer}>
                <Sparkles size={14} color={isDark ? '#8E8E9E' : '#B0B0C0'} />
                <Text style={[styles.decorativeText, { color: isDark ? '#8E8E9E' : '#B0B0C0' }]}>
