    ...
    >
      ...
      >
        <View style={[styles.modalHeader, { borderBottomColor: colors.border || '#e0e0e0' }]}>
          ...
          <Text style={[styles.modalTitle, { color: colors.text }]}>Ajouter un véhicule</Text>
          <View style={{ width: 40 }} />
        </View>
        ...
        >
          <Card style={styles.fullScreenCard}>
            ...
            <View style={styles.optionsContainer}>
              <OptionToggle 
                icon={<Wind size={18} color={colors.tint} />} 
                label="Climatiseur" 
                value={hasAC} 
                onToggle={setHasAC} 
              ...
              />
              <OptionToggle 
                icon={<Briefcase size={18} color={colors.tint} />} 
                label="Compartiment bagage" 
                value={hasLuggage} 
                onToggle={setHasLuggage} 
                accentColor={colors.tint} 
              />
              <OptionToggle 
                icon={<Wifi size={18} color={colors.tint} />} 
                label="Wi-Fi à bord" 
                value={hasWifi} 
                onToggle={setHasWifi} 
                accentColor={colors.tint} 
              />
              <OptionToggle 
                icon={<Music size={18} color={colors.tint} />} 
                label="Système audio" 
                value={hasMusic} 
                onToggle={setHasMusic} 
                accentColor={colors.tint} 
              />
              <OptionToggle 
                icon={<PawPrint size={18} color={colors.tint} />} 
                label="Animaux acceptés" 
                value={isPetFriendly} 
                onToggle={setIsPetFriendly} 
                accentColor={colors.tint} 
                isLast 
              />
            </View>
            ...
            <View style={styles.formButtons}>
              <Button title="Enregistrer le Véhicule" onPress={handleSubmit} loading={loading} />
...
const styles = StyleSheet.create({
  ...
  formButtons: { marginTop: 20, gap: 10 },
