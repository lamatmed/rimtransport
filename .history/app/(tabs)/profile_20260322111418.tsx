import { StyleSheet, TouchableOpacity, ScrollView, useColorScheme, Alert, Dimensions, Animated } from 'react-native';
...
export default function ProfileScreen() {
  ...
  const ProfileOption = ({ icon, title, onPress, showChevron = true, color = colors.text, badge }: any) => (
    <TouchableOpacity 
      ...
      <View style={styles.optionLeft}>
        <LinearGradient
          colors={[mauritaniaGold + '20', mauritaniaGreen + '20']}
  ...
  const StatCard = ({ icon, value, label }: any) => (
    <LinearGradient
      colors={[mauritaniaGreen + '15', mauritaniaGold + '10']}
  ...
  return (
    <ScrollView 
      ...
      {/* Header avec dégradé */}
      <LinearGradient
        colors={[mauritaniaGreen, mauritaniaGreen + 'CC']}
        ...
        <Animated.View 
          ...
          <View style={styles.avatarContainer}>
            <LinearGradient
              colors={[mauritaniaGold, mauritaniaGold + 'DD']}
          ...
          <View style={styles.roleContainer}>
            <LinearGradient
              colors={[mauritaniaGold, mauritaniaRed]}
          ...
          <View style={styles.infoPill}>
            ...
            <Text style={[styles.phoneText, { color: '#FFF' }]}>{profile?.phone}</Text>
          </View>
        </Animated.View>
      </LinearGradient>
