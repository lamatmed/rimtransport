  ...
  return (
    <div className="fade-in" style={{ padding: "1.5rem 0 6rem 0" }}>
      ...
      <div style={{ padding: "0 1.25rem" }}>
        ...
        <div className="card-premium" style={{ overflow: "hidden" }}>
          <ProfileOption icon={<HelpCircle size={20} color="var(--primary-green)" />} title={t('help_support')} onClick={() => router.push('/search')} />
      ...
      {showInfoModal && (
        <div style={{ position: "fixed", top: 0, left: 0, right: 0, bottom: 0, background: "rgba(0,0,0,0.5)", zIndex: 1000, display: "flex", alignItems: "flex-end" }}>
          <div className="fade-in" style={{ width: "100%", maxWidth: "600px", margin: "0 auto", background: "white", borderTopLeftRadius: "24px", borderTopRightRadius: "24px", padding: "2rem", maxHeight: "90vh", overflowY: "auto" }}>
